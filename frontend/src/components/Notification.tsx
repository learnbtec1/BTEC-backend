...
export default function NeuralNotification({ message, type, onClose }: any) {
  const config = {
  ...
  return (
    <div className={`neural-alert holo-card p-4 rounded-2xl border-l-4 ${style.border} ${style.shadow} w-80 mb-4 flex gap-4 items-start`}>
